...
var myStepDefinitionsWrapper = function () {
    ...
    require('../support/hooks.js').call(this);
    console.log(this);
...
},{"../support/hooks.js":3,"../support/world.js":5}],2:[function(require,module,exports){
var myStepDefinitionsWrapper = function () {
...
},{"../support/world.js":5}],3:[function(require,module,exports){
/*jslint node: true */
"use strict";
...
// flase als de arrays niet hetzelfde zijn, anders true
//Array.prototype.SequenceEqual = function(a){
...
//}
//
//// geeft de kleinste in de reeks terug
...
//}
//
//// vervangt iedere this[i] door func(this[i])
...
//}
//
//// Geeft alleen elementen this[i] terug waarvoor func(this[i]) == true
//Array.prototype.Where = function(func){
//    var a = new Array();
//    for (var i = 0; i < this.length; i++){
//        if (func(this[i])) a.push(this[i]);
//    }
//    return a;
//}
//

// geeft een viercijferige code terug die nodig is om in te loggen op het patientenportaal
function CalculateSecurityToken(mac){
    return GetPi().substr(GetSearchPositionInPi(mac), 4);
}

function GetSearchPositionInPi(mac){
    var xornibs = GetXoredNibbles(mac);
    return Math.round((10000 - 4) * (((xornibs[0] << 12) + (xornibs[1] << 8) + (xornibs[2] << 4) + (xornibs[3])) / 65535));
}

function GetXoredNibbles(mac){
    var mnibs = GetLastFourNibblesOfMac(mac);
    var tnibs = GetLastFourNibblesOfTime();
    return [mnibs[0] ^ tnibs[0], mnibs[1] ^ tnibs[1], mnibs[2] ^ tnibs[2], mnibs[3] ^ tnibs[3]];
}

function GetLastFourNibblesOfMac(mac){
    //var mac = GetMac();
    return [parseInt(mac[8], 16), parseInt(mac[9], 16), parseInt(mac[10], 16), parseInt(mac[11], 16)];
}

function GetLastFourNibblesOfTime() {
    var time = Math.round(new Date().getTime() / 60000 + 120);
    console.log("time "+time);
    return [time & 0x0f, (time >> 4) & 0x0f, (time >> 8) & 0x0f, (time >> 12) & 0x0f];
}
//
//// tijd in minuten
//function GetTime(){
//    return Math.round(gw.GetTime() / 60);
//}

// haalt het kleinste macadres op van de apparaatjes aan de HM
//function GetMac(){
//    var devices = new Array();
//    gw.GetCurrentPeripherals(devices);
//    return devices.map(function(m){return gw.GetDeviceInfo(m)})                                       // haal info op aan de hand van de naampjes
//        .map(function(m){return m.substr(0, m.indexOf("-")) + ""})          // in het eerste stukje voor de "-" moet het MAC-adres staan
//        .filter(function(m){return m.length == 12;})                                           // MAC-adressen hebben lengte 12; neem dit als voorwaarde
//        .Min();                                                                                                                         // .. en pak de kleinste
//}

function GetPi(){
    return "";
}

module.exports = tan = CalculateSecurityToken;
...
var WorldConstructor = function WorldConstructor(callback) {
    ...
    dsl = {
        ...
        requestTan: function (done) {
            app.click('#requestTancode').then(done);
        },
        ...
        shouldBeLoggedIn: function (username, done) {
            expect(app.App.Auth.get('user'))
...
},{"../support/tan.js":4,"chai":14,"chai-as-promised":13}],6:[function(require,module,exports){
// UTILITY
...
},{"buffer":10,"util":8}],7:[function(require,module,exports){
...
},{"./buffer_ieee754":9,"assert":6,"base64-js":11}],11:[function(require,module,exports){
(function (exports) {
	'use strict';
...
},{"./chai/assertion":16,"./chai/core/assertions":17,"./chai/interface/assert":18,"./chai/interface/expect":19,"./chai/interface/should":20,"./chai/utils":32,"assertion-error":41}],16:[function(require,module,exports){
/*!
 * chai
 * http://chaijs.com
 * Copyright(c) 2011-2013 Jake Luer <jake@alogicalparadox.com>
...
},{"./transferFlags":38}],22:[function(require,module,exports){
/*!
...
},{"./getEnumerableProperties":27,"buffer":10}],25:[function(require,module,exports){
/*!
 * Chai - flag utility
 * Copyright(c) 2012-2013 Jake Luer <jake@alogicalparadox.com>
 * MIT Licensed
...
},{"./addChainableMethod":21,"./addMethod":22,"./addProperty":23,"./eql":24,"./flag":25,"./getActual":26,"./getMessage":28,"./getName":29,"./getPathValue":30,"./inspect":33,"./objDisplay":34,"./overwriteMethod":35,"./overwriteProperty":36,"./test":37,"./transferFlags":38,"./type":39}],33:[function(require,module,exports){
...
},{"./inspect":33}],35:[function(require,module,exports){
/*!
...
},{"./flag":25}],38:[function(require,module,exports){
/*!
...
},{}],"steps":[function(require,module,exports){
module.exports=require('Yp3+x1');
